                   ...
                   <div class="form-group row">
                    ...
                    <label class="col-md-4 col-form-label text-md-left">{!! $Galeri->path !!}</label>
               		 ...
               		 <div class="form-group row">
               		 	...
               		 	<label class="col-md-4 col-form-label text-md-left">{!! $Galeri->created_at->format('d/m/Y H:i') !!}</label>
               		 </div>

               		 <div class="form-group row">
               		 	<label class="col-md-4 col-form-label text-md-right">Update</label>
               		 	<label class="col-md-4 col-form-label text-md-left">{!! $Galeri->updated_at->format('d/m/Y H:i') !!}</label>
               		 </div>
