            ...
            <div class="card">
                ...
                <div class="card-body">
               		 ...
               		 <div class="form-group row">
               		 	...
               		 	<label class="col-md-4 col-form-label text-md-left">{!! $Artikel->judul !!}</label>
               		 </div>

                  <div class="form-group row">
                    <label class="col-md-4 col-form-label text-md-right">Isi</label>
                    <label class="col-md-4 col-form-label text-md-left">{!! $Artikel->isi !!}</label>
                   </div>
               		 ...
               		 <div class="form-group row">
               		 	...
               		 	<label class="col-md-4 col-form-label text-md-left">{!! $Artikel->created_at->format('d/m/Y H:i') !!}</label>
               		 </div>

               		 <div class="form-group row">
               		 	<label class="col-md-4 col-form-label text-md-right">Update</label>
               		 	<label class="col-md-4 col-form-label text-md-left">{!! $Artikel->updated_at->format('d/m/Y H:i') !!}</label>
               		 </div>
